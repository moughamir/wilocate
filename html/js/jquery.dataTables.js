...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input id="input_filter" type="text" /> <img src="../img/clear.png" title="Clear search parameters"  onmouseover="this.src=\'img/clear_over.png\'" onmouseout="this.src=\'img/clear.png\'" alt="Clear" id="clear_button" style="vertical-align:middle;"/>';
