...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input id="input_filter" type="text" /> <img src="../img/show_all.png" title="Clear search parameters"  onmouseover="this.src=\'img/show_all_over.png\'" onmouseout="this.src=\'img/show_all.png\'" alt="Clear" id="clear_button" style="vertical-align:middle;"/>';
